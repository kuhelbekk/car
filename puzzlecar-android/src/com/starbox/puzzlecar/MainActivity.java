...
public class MainActivity extends AndroidApplication implements Pay {
 ...
 // Listener that's called when we finish querying the items and subscriptions we own
	...
	public void playToy() {
		...
		// packageName - им€ пакета
		Intent LaunchIntent = getPackageManager().getLaunchIntentForPackage("com.starbox.puzzletoy");
	...
	@Override
	public void showToast( final String exitText) {
		uiThread.post(new Runnable() {
            public void run() {
                    Toast.makeText(appContext, exitText, Toast.LENGTH_SHORT).show();
            }
    });
	}
}